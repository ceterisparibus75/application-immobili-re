...
export const PRIMARY_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Gestion des locataires", href: "/locataires", icon: Users },
      ...
      { name: "Tickets locataires", href: "/tickets", icon: MessageSquare },
    ],
  },
  {
    title: "Finances",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Preuves d'envoi", href: "/documents/preuves-envoi", icon: MailCheck },
