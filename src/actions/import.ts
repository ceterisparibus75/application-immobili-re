...
Structure exacte :
{
  ...
  "bail": {
    "leaseType": "HABITATION|MEUBLE|ETUDIANT|MOBILITE|COLOCATION|SAISONNIER|LOGEMENT_FONCTION|ANAH|CIVIL|GLISSANT|SOUS_LOCATION|COMMERCIAL_369|DEROGATOIRE|PRECAIRE|BAIL_PROFESSIONNEL|MIXTE|EMPHYTEOTIQUE|CONSTRUCTION|REHABILITATION|BRS|RURAL|AUTORISATION_OCCUPATION_TEMPORAIRE|CONVENTION_OCCUPATION_PRECAIRE|CONVENTION_OCCUPATION_TEMPORAIRE|BAIL_METAYAGE|CONVENTION_COLIVING|CONVENTION_MISE_A_DISPOSITION|BAIL_GLISSANT|BAIL_LOI_48|LOCATION_PARKING|LOCATION_STOCKAGE|DROIT_DE_PASSAGE|AUTRE",
