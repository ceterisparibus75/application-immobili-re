      ...
      <HelpSection id="faq" title="Questions fréquentes sur le patrimoine">
        <div className="space-y-3">
          ...
          <div className="rounded-lg border p-4">
            ...
            <p>Rendez-vous dans <strong>Import données &gt; Import CSV / Excel</strong> et uploadez un fichier contenant les colonnes suivantes : numéro lot, type lot, surface, étage et nom d'immeuble. L'application vérifie les données et crée les lots automatiquement.</p>
          </div>
          <div className="rounded-lg border p-4">
