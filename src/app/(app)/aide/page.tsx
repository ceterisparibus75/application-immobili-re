...
const faqs = [
  ...
  // Import / Export
  { q: "Puis-je importer mes données depuis un autre logiciel ?", a: "Oui, Administration > Import permet d'importer des locataires, immeubles, lots et baux depuis un fichier CSV ou Excel. Un assistant vous guide dans le mappage des colonnes. L'import IA (Enterprise) peut aussi extraire les données directement depuis un PDF de bail." },
