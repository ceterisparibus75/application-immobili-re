...
const searchableGuides = [
  ...
  { slug: "facturation", title: "Facturation et paiements", description: "Factures, paiements, relances, SEPA, quittances et compte locataire." },
...
const guides = [
  ...
  },
  {
    ...
    description: "Baux, vie du bail, locataires, charges et contacts.",
  ...
  },
  {
    ...
    description: "Factures, paiements, compte locataire et quittances.",
...
const faqs = [
  ...
  { q: "Comment changer le locataire d'un bail en cours ?", a: "Ouvrez le bail, allez dans l'onglet « Vie du bail », puis cliquez sur « Changer le locataire ». Sélectionnez le repreneur, la date d'effet et la nature de l'opération (cession du fonds, cession du droit au bail, substitution...). Le bail conserve son numéro et l'ancien titulaire reste historisé." },
