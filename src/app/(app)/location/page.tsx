...
import { getLocationGuidance } from "@/lib/module-guidance";
...
export default async function LocationPage() {
  ...
  const guidanceSteps = getLocationGuidance({
    activeLeases,
    activeTenants,
    lateInvoices,
    openTickets,
          ...
          <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Les raccourcis les plus utiles selon l'état actuel du portefeuille locatif.
              </p>
            </div>
          </div>
