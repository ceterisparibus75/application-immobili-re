  ...
  async function handleFileUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const data = json.data as {
        ...
        lines: Array<{ lineType: string; label: string; amount: number; nature?: string }>;
        confidence: number;
      };
      ...
      if (data.lines.length > 0) {
        setLines(data.lines.map((l) => ({
          ...
          amount: l.amount,
          lineType: "CHARGE",
          nature: (["RECUPERABLE", "PROPRIETAIRE", "MIXTE"].includes(l.nature ?? "")
            ? l.nature!
            : "RECUPERABLE"),
        })));
      }
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card className="border-dashed">
        <CardHeader>
          ...
          <CardDescription>
            Importez le PDF du relevé pour pré-remplir automatiquement le formulaire
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-4">
