    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          <section><h2 className="text-xl font-semibold mb-4">1. Responsable du traitement</h2><p className="text-muted-foreground">MyGestia, joignable a <strong className="text-foreground">contact@mygestia.immo</strong>, est responsable du traitement de vos donnees personnelles.</p></section>
