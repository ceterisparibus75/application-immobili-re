-- Baseline migration — état complet du schéma au 26 avril 2026
-- Généré par : npx prisma migrate diff --from-empty --to-schema prisma/schema.prisma --script
-- Sur une base EXISTANTE : npx prisma migrate resolve --applied 20260426000000_baseline
-- Sur une base NEUVE     : npx prisma migrate deploy
...
-- CreateEnum
CREATE TYPE "FiscalRegime" AS ENUM ('MICRO_FONCIER', 'REEL_FONCIER', 'LMNP_MICRO_BIC', 'LMNP_REEL', 'LMP', 'MEUBLE_TOURISME');
...
-- CreateEnum
CREATE TYPE "LeaseDestination" AS ENUM ('HABITATION', 'BUREAU', 'COMMERCE', 'ACTIVITE', 'ENTREPOT', 'INDUSTRIEL', 'PROFESSIONNEL', 'MIXTE', 'PARKING', 'TERRAIN', 'AGRICOLE', 'HOTELLERIE', 'EQUIPEMENT', 'AUTRE');
...
-- CreateEnum
CREATE TYPE "RevisionDateBasis" AS ENUM ('DATE_SIGNATURE', 'DATE_ENTREE', 'PREMIER_JANVIER', 'DATE_PERSONNALISEE');
...
-- CreateEnum
CREATE TYPE "LoanType" AS ENUM ('AMORTISSABLE', 'IN_FINE', 'BULLET', 'OBLIGATION', 'COMPTE_COURANT');
...
-- CreateEnum
CREATE TYPE "SupplierInvoiceStatus" AS ENUM ('PENDING_REVIEW', 'VALIDATED', 'REJECTED', 'PAID', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "SupplierPaymentMethod" AS ENUM ('SEPA_XML', 'QONTO', 'MANUAL');

-- CreateEnum
CREATE TYPE "SupplierPaymentStatus" AS ENUM ('PENDING', 'SUBMITTED', 'CONFIRMED', 'FAILED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "AmendmentType" AS ENUM ('RENOUVELLEMENT', 'AVENANT_LOYER', 'AVENANT_DUREE', 'AVENANT_DIVERS', 'RESILIATION');

-- CreateEnum
CREATE TYPE "LegalEventType" AS ENUM ('CESSION', 'CONGE', 'EVICTION', 'COMMANDEMENT_PAYER', 'ACTE_HUISSIER', 'RENOUVELLEMENT_CONTESTE', 'SOUS_LOCATION', 'DESPECIALISATION', 'MISE_EN_DEMEURE', 'AUTRE');

-- CreateEnum
CREATE TYPE "LegalEventStatus" AS ENUM ('OUVERT', 'EN_COURS', 'RESOLU', 'CLASSE');
...
-- CreateEnum
CREATE TYPE "StatementType" AS ENUM ('APPEL_FONDS', 'DECOMPTE_CHARGES', 'DECOMPTE_GESTION');

-- CreateEnum
CREATE TYPE "StatementStatus" AS ENUM ('BROUILLON', 'VALIDE', 'PAYE', 'PARTIELLEMENT_PAYE', 'REGULARISE', 'VERIFIE', 'CONFORME', 'LITIGE');
...
CREATE TABLE "Society" (
    ...
    "ppfRegisteredAt" TIMESTAMP(3),
    "paOAuthAccessToken" TEXT,
    "paOAuthRefreshToken" TEXT,
    "paOAuthTokenExpiresAt" TIMESTAMP(3),
    "ownerId" TEXT,
    "proprietaireId" TEXT,
    "leasePrefix" TEXT,
...
CREATE TABLE "Lease" (
    ...
    "revisionDateBasis" "RevisionDateBasis" DEFAULT 'DATE_SIGNATURE',
    "revisionCustomMonth" INTEGER,
    "revisionCustomDay" INTEGER,
...
CREATE TABLE "LegalEvent" (
    ...
    "dueDate" TIMESTAMP(3),
    "status" "LegalEventStatus" NOT NULL DEFAULT 'OUVERT',
...
-- CreateTable
CREATE TABLE "TransactionAutoTag" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "societyId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "ThirdPartyStatement" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "societyId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "ThirdPartyStatementLine" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "ThirdPartyStatementLease" (
    "id" TEXT NOT NULL,
    "statementId" TEXT NOT NULL,
    "leaseId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "PAOAuthState" (
    "id" TEXT NOT NULL,
    "societyId" TEXT NOT NULL,
    "codeVerifier" TEXT NOT NULL,
    "expiresAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "PAOAuthState_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Lease_societyId_deletedAt_idx" ON "Lease"("societyId", "deletedAt");
...
-- CreateIndex
CREATE INDEX "LeaseLot_leaseId_idx" ON "LeaseLot"("leaseId");

-- CreateIndex
CREATE INDEX "LeaseLot_lotId_idx" ON "LeaseLot"("lotId");

-- CreateIndex
CREATE UNIQUE INDEX "LeaseLot_leaseId_lotId_key" ON "LeaseLot"("leaseId", "lotId");
...
-- CreateIndex
CREATE INDEX "LegalEvent_societyId_idx" ON "LegalEvent"("societyId");

-- CreateIndex
CREATE INDEX "LegalEvent_leaseId_idx" ON "LegalEvent"("leaseId");

-- CreateIndex
CREATE INDEX "LegalEvent_societyId_type_idx" ON "LegalEvent"("societyId", "type");

-- CreateIndex
CREATE INDEX "LegalEvent_societyId_status_idx" ON "LegalEvent"("societyId", "status");
...
-- CreateIndex
CREATE INDEX "Tenant_societyId_deletedAt_idx" ON "Tenant"("societyId", "deletedAt");
...
-- CreateIndex
CREATE INDEX "Charge_statementId_idx" ON "Charge"("statementId");
...
-- CreateIndex
CREATE INDEX "Invoice_societyId_status_dueDate_idx" ON "Invoice"("societyId", "status", "dueDate");
...
-- CreateIndex
CREATE INDEX "BankReconciliation_statementId_idx" ON "BankReconciliation"("statementId");
...
-- CreateIndex
CREATE INDEX "TransactionAutoTag_societyId_idx" ON "TransactionAutoTag"("societyId");

-- CreateIndex
CREATE UNIQUE INDEX "TransactionAutoTag_societyId_normalizedLabel_key" ON "TransactionAutoTag"("societyId", "normalizedLabel");
...
-- CreateIndex
CREATE INDEX "Document_societyId_deletedAt_idx" ON "Document"("societyId", "deletedAt");
...
-- CreateIndex
CREATE INDEX "ThirdPartyStatement_societyId_idx" ON "ThirdPartyStatement"("societyId");

-- CreateIndex
CREATE INDEX "ThirdPartyStatement_buildingId_idx" ON "ThirdPartyStatement"("buildingId");

-- CreateIndex
CREATE INDEX "ThirdPartyStatement_leaseId_idx" ON "ThirdPartyStatement"("leaseId");

-- CreateIndex
CREATE INDEX "ThirdPartyStatement_societyId_type_idx" ON "ThirdPartyStatement"("societyId", "type");

-- CreateIndex
CREATE INDEX "ThirdPartyStatement_societyId_status_idx" ON "ThirdPartyStatement"("societyId", "status");

-- CreateIndex
CREATE INDEX "ThirdPartyStatementLine_statementId_idx" ON "ThirdPartyStatementLine"("statementId");

-- CreateIndex
CREATE INDEX "ThirdPartyStatementLine_leaseId_idx" ON "ThirdPartyStatementLine"("leaseId");

-- CreateIndex
CREATE INDEX "ThirdPartyStatementLease_statementId_idx" ON "ThirdPartyStatementLease"("statementId");

-- CreateIndex
CREATE INDEX "ThirdPartyStatementLease_leaseId_idx" ON "ThirdPartyStatementLease"("leaseId");

-- CreateIndex
CREATE UNIQUE INDEX "ThirdPartyStatementLease_statementId_leaseId_key" ON "ThirdPartyStatementLease"("statementId", "leaseId");
...
-- CreateIndex
CREATE UNIQUE INDEX "SupplierInvoice_ppfInvoiceId_key" ON "SupplierInvoice"("ppfInvoiceId");
...
-- CreateIndex
CREATE INDEX "SupplierInvoice_accountingAccountId_idx" ON "SupplierInvoice"("accountingAccountId");
...
-- CreateIndex
CREATE INDEX "PAOAuthState_societyId_idx" ON "PAOAuthState"("societyId");

-- CreateIndex
CREATE INDEX "PAOAuthState_expiresAt_idx" ON "PAOAuthState"("expiresAt");
...
-- AddForeignKey
ALTER TABLE "Building" ADD CONSTRAINT "Building_coproprieteId_fkey" FOREIGN KEY ("coproprieteId") REFERENCES "Copropriete"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Lot" ADD CONSTRAINT "Lot_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "Building"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LeaseRentStep" ADD CONSTRAINT "LeaseRentStep_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeaseLot" ADD CONSTRAINT "LeaseLot_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeaseLot" ADD CONSTRAINT "LeaseLot_lotId_fkey" FOREIGN KEY ("lotId") REFERENCES "Lot"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LegalEvent" ADD CONSTRAINT "LegalEvent_societyId_fkey" FOREIGN KEY ("societyId") REFERENCES "Society"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LegalEvent" ADD CONSTRAINT "LegalEvent_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Charge" ADD CONSTRAINT "Charge_statementId_fkey" FOREIGN KEY ("statementId") REFERENCES "ThirdPartyStatement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ChargeRegularization" ADD CONSTRAINT "ChargeRegularization_sourceStatementId_fkey" FOREIGN KEY ("sourceStatementId") REFERENCES "ThirdPartyStatement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BankReconciliation" ADD CONSTRAINT "BankReconciliation_statementId_fkey" FOREIGN KEY ("statementId") REFERENCES "ThirdPartyStatement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LoanMovement" ADD CONSTRAINT "LoanMovement_loanId_fkey" FOREIGN KEY ("loanId") REFERENCES "Loan"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ThirdPartyStatement" ADD CONSTRAINT "ThirdPartyStatement_societyId_fkey" FOREIGN KEY ("societyId") REFERENCES "Society"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatement" ADD CONSTRAINT "ThirdPartyStatement_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "Building"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatement" ADD CONSTRAINT "ThirdPartyStatement_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatement" ADD CONSTRAINT "ThirdPartyStatement_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "Contact"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatement" ADD CONSTRAINT "ThirdPartyStatement_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatementLine" ADD CONSTRAINT "ThirdPartyStatementLine_statementId_fkey" FOREIGN KEY ("statementId") REFERENCES "ThirdPartyStatement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatementLine" ADD CONSTRAINT "ThirdPartyStatementLine_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatementLease" ADD CONSTRAINT "ThirdPartyStatementLease_statementId_fkey" FOREIGN KEY ("statementId") REFERENCES "ThirdPartyStatement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ThirdPartyStatementLease" ADD CONSTRAINT "ThirdPartyStatementLease_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInboxConfig" ADD CONSTRAINT "SupplierInboxConfig_societyId_fkey" FOREIGN KEY ("societyId") REFERENCES "Society"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_societyId_fkey" FOREIGN KEY ("societyId") REFERENCES "Society"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "Building"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_leaseId_fkey" FOREIGN KEY ("leaseId") REFERENCES "Lease"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "ChargeCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_accountingAccountId_fkey" FOREIGN KEY ("accountingAccountId") REFERENCES "AccountingAccount"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_chargeId_fkey" FOREIGN KEY ("chargeId") REFERENCES "Charge"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SupplierInvoice" ADD CONSTRAINT "SupplierInvoice_bankAccountId_fkey" FOREIGN KEY ("bankAccountId") REFERENCES "BankAccount"("id") ON DELETE SET NULL ON UPDATE CASCADE;
